...
if __name__ == "__main__":
	filelist = "../First250riddles/riddlesDetectionAll/filelist.txt";
	iurInferenceFolder = sys.argv[1];
	baselineInferenceFolder = sys.argv[2];
	numberOfImages = 500;
	baseURL = "http://www.umiacs.umd.edu/~yzyang/riddles/";
	amtCSVFile = open("amtCSV.csv",'w');

	amtCSVFile.write("image_url1,image_url2,image_url3,image_url4,text1,text2,text3\n");
	with open(filelist,'r') as f:
		...
		for line in f:
			...
			opString = "";
			print riddlePrefix;
			if iurWord != None and baselineWord != None:
				for j in range(1,5):

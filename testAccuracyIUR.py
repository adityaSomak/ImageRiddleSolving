...
print("python ",sys.argv[0]," <seedsCentralityfile> <detectionsFolder> <number-of-puzzles> <inferenceFolder> <partnumber>,<parts>")
...
if partNumber != -1:
	accuracyFile = open('accuracyResults/accuracyFile_all_puzzles_'+str(partNumber)+'_iur.txt','w');
else:
...
for choice in parameterSpace:
	if partNumber != -1:
		puzzleAccuracyFile = open('accuracyResults/accuracyFile_all_puzzles_'+str(tries)+'_'+str(partNumber)+'_iur.txt','w');
	else:
